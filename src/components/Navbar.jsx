import { FaDiscourse, FaHeart, FaHome, FaMeteor, FaUserAstronaut } from 'react-icons/fa';
  ...
  return (
    <>
      <div className="d-flex justify-content-center mt-4">
        ...
        <NavLink to={'/FaqPage'} className={isActiveLink}>
          <FaDiscourse size={'1.2rem'} className="me-2 text-danger" /> FAQ
        </NavLink>
      </div>
    </>
  );
